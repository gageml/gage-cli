# `gage log delete` command
    ...
    Delete logs
    ⤶
    Usage: gage log delete [OPTIONS] [SPEC]...
    ⤶
    Arguments:
      [SPEC]...
              Log(s) to delete
...
Delete log 1.
    ...
    >>> run("gage log delete 1 -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
...
Delete the second log by ID.
    ...
    >>> run(f"gage log delete {id2} -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
...
Delete `2:3`
    ...
    >>> run("gage log delete 2:3 -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
...
Delete `:2`
    ...
    >>> run("gage log restore --all -y", quiet=True)
    >>> run("gage log delete 1:2 -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
...
Delete `3:`.
    ...
    >>> run("gage log restore --all -y", quiet=True)
    >>> run("gage log delete 3: -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
...
Try to delete the log.
    ...
    >>> run(f"gage log delete {id1} -y", cols=72)  # +parse +table
    ┌  Delete logs
    │
    ├  ╭────────┬──────┬──────┬─────────┬───────────┬─────────┬─────────╮
    │  │ Id     │ Task │ Type │ Status  │ Model     │ Dataset │ Started │
