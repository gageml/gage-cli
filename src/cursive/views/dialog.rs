...
use cursive::{
    ...
    views::{BoxedView, DummyView, LastSizeView, TextView},
};
use parking_lot::Mutex;
use std::cmp::{max, min};

use crate::cursive::{PrinterExt, views::Button};
...
impl View for Dialog {
    fn draw(&self, printer: &Printer) {
        ...
        // Print the borders
        printer.print_box_rounded(Vec2::new(0, 0), printer.size, false);
...
cursive::fn_blueprint!("Dialog.info", |config, context| {
