...
pub fn init() {
    // Switch to use PyConfig API to initialize Python - used to set
    // `executable` when running in a virtual env (see notes below for
    // details)
    if std::env::var("PY_CONFIG_INIT").is_ok() {
